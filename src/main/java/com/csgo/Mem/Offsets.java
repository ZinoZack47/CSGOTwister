...
public abstract class Offsets
{
    ...
    protected final static long m_bInReload = 0x32A5;
    protected final static long m_bIsScoped = 0x3928;
    protected final static long m_bSpotted = 0x93D;
    protected final static long m_dwBoneMatrix = 0x26A8;
    protected final static long m_fFlags = 0x104;
    protected final static long m_flFlashDuration = 0xA420;
    ...
    protected final static long m_iHealth = 0x100;
    protected final static long m_iItemDefinitionIndex = 0x2FAA;
    protected final static long m_iTeamNum = 0xF4;
    ...
    protected final static long dwEntityList = 0x4DA31DC;
    protected final static long dwGameRulesProxy = 0x52C02BC;
